...
class AdminIndexController extends \app\admin\controller\PluginAdminBaseController
{
    ...
    public function index()
    {
        ...
        $page_info["page"] = max(1, ceil($count / $limit));
    ...
    public function setting()
    {
        ...
        $default_system = $this->getPlugin()->getDefaultConfig();
        $current_config = $res ? json_decode($res["config"], true) : [];
        $system = array_merge($default_system, $current_config ?: []);
        ...
        if ($this->request->isPost()) {
            ...
            $system["realname_required"] = $param["realname_required"] ?? 0;

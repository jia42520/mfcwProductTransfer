...
<style>
.product-divert-client {
    color: #1f2937;
}
.product-divert-client .card-body {
    padding: 22px;
}
.product-divert-client .table-header {
    display: flex;
...
.product-divert-client .table-filter:before {
    display: block;
    content: "产品转移列表";
    margin-bottom: 6px;
    font-size: 22px;
...
.product-divert-client .table-filter:after {
    display: block;
    content: "查看您发起或接收的产品转移记录。";
    color: #6b7280;
}
.product-divert-client .table-search .form-control {
    height: 36px;
    border-color: #d1d5db;
    border-radius: 6px;
}
.product-divert-client .table-responsive {
    min-height: 385px;
}
.product-divert-client .table {
    margin-bottom: 0;
    color: #374151;
}
.product-divert-client .table thead th {
    padding: 12px 14px;
    border: 0;
...
.product-divert-client .table td {
    padding: 14px;
    border-color: #edf2f7;
    vertical-align: middle;
    white-space: nowrap;
}
.product-divert-client .table td:first-child {
    max-width: 320px;
    overflow: hidden;
    color: #111827;
    font-weight: 600;
...
.product-divert-client .table td:nth-child(3),
.product-divert-client .table td:nth-child(6),
.product-divert-client .table td:nth-child(7) {
    color: #374151;
    font-weight: 600;
}
.product-divert-client .table td:nth-child(6),
...
.product-divert-client .table td a {
    display: inline-flex;
    align-items: center;
    gap: 4px;
    margin-bottom: 4px;
}
.product-divert-client .table-footer {
    display: flex;
    align-items: center;
...
.product-divert-client .table-pagination,
.product-divert-client .table-pageinfo {
    display: flex;
    align-items: center;
    gap: 12px;
}
.product-divert-client #limitSel {
    min-width: 76px;
    height: 32px;
...
.product-divert-client .modal-content {
    border: 0;
    border-radius: 8px;
    box-shadow: 0 18px 48px rgba(15, 23, 42, .18);
}
.product-divert-client .modal-header {
    border-bottom-color: #eef2f7;
}
.product-divert-client .modal-title {
    font-weight: 700;
    color: #111827;
}
.product-divert-client .modal-body .form-group {
    margin-bottom: 18px;
}
.product-divert-client .modal-body .col-form-label {
    color: #6b7280;
    font-weight: 600;
}
.product-divert-client .modal-footer {
    padding-right: 0;
...
@media (max-width: 767px) {
    ...
    .product-divert-client .table-search {
        justify-content: flex-start !important;
    }
}
</style>
<div class="card product-divert-client">
<div class="card-body">
              ...
              <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10"><h4 id="usertext"></h4>
                      <input class="form-control" id="search" type="text" value="" placeholder="请输入接受方手机号或邮箱">
                    </div>
